...
for MYINDUCTION in gRNA;do #RNP; do # gRNA;do
...
for MYTARGET in Psy1; do #Psy1_allb PhyB2.2_allb CRTISO_allb;do #CRTISO Psy1 CRTISO_all; do #PhyB2.2_R2_Feb2022 Psy1_R2_Feb2022;do #CRTISO.cleanedandnov2021 CRTISO.nov2021.49and50 Psy1 PhyB2.2.nov2021 CRTISO.nov2021; do 
...
for MYINDUCTION_CURVE in 2;do # 3 4; do # 2 4
for mymodel in modelDSBs1i1_3x4.bytarget;do #modelDSBs1i1_mini.bytarget; do 
for MYTARGET in Psy1_all PhyB2.2_all CRTISO_all;do #Psy1_R2_Feb2022;do #CRTISO.cleanedandnov2021 CRTISO.nov2021.49and50 Psy1 PhyB2.2.nov2021 CRTISO.nov2021; do 
...
for MYINDUCTION in RNP; do # gRNA;do
for MYINDUCTION_CURVE in 2;do # 3 4; do # 2 4
for mymodel in modelDSBs1i1_3x4.bytarget;do  # modelDSBs1i1_3x4;do #modelDSBs1i1_mini modelDSBs1i1_nok12;do #modelDSBs1i1_mini.bytarget modelDSBs1i1_mini modelDSBs1i1_3x4 modelDSBs1i1_nok12; do 
for MYTARGET in CRTISO_all Psy1_all PhyB2.2_all;do #CRTISO_allb Psy1_allb PhyB2.2_allb;do #CRTISO.cleanedandnov2021;do
...
#CALCULATE CI
#----likelihood based
for MYN in 50000 500000;do # 500000;do # 150000 2000000
for MYDELAY in '';do # _mydelay0.25;do #''
...
for MYTARGET in PhyB2.2_R2_Feb2022 Psy1_R2_Feb2022 Psy1_allb PhyB2.2_allb CRITSO_allb;do #CRTISO.nov2021.49and50 Psy1 PhyB2.2.nov2021 CRTISO.nov2021;do 
...
for MYTARGET in PhyB2.2_R2_Feb2022 Psy1_R2_Feb2022 Psy1_allb PhyB2.2_allb CRITSO_allb; do #Psy1 PhyB2.2.nov2021 CRTISO.nov2021 CRTISO.cleanedandnov2021 CRTISO.nov2021.49and50 ;do 
MYTARGETM=$( echo $MYTARGET | sed 's/_allb//' |  sed 's/_all//' | sed 's/_R2_Feb2022//' | sed 's/0h//' | sed 's/m$//' | sed 's/72h//' )
ERRORMATRIX=~/workspace/daniela/error_matrices/error_matrix4_${MYTARGETM}_errorsfromunbroken.tsv
TIMECOURSE=~/workspace/daniela/input_datasets/timecourse_${MYINDUCTION}_${MYTARGET}${MYDELAY}.txt
likfun=0; if [ $mymodel == "modelDSBs1i1_3x4" ];then likfun=3; fi
