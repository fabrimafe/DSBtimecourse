...
for MYTARGET in Psy1.24h;do #Psy1.june2023 Psy1.june2023.24h;do #Psy1_real0;do #Psy1.9timepoint24h CRTISO.9timepoint24h PhyB2.9timepoint24h;do #Psy1.9timepoint CRTISO.9timepoint PhyB2.9timepoint;do #Psy1 CRTISO.nov2021.49and50 PhyB2.2.nov2021;do # CRTISO.nov2021 Psy1_allb PhyB2.2_allb;do #PhyB2 CRTISO.cleaned CRTISO_allb CRTISO.49and50bp_allb Psy1_allb PhyB2.2_allb Psy1 PhyB2.2.nov2021 PhyB2.2_R2_Feb2022 Psy1_R2_Feb2022 CRTISO.nov2021.49and50 CRTISO.nov2021;do  
MYTARGETM=$( echo $MYTARGET | sed 's/_allb//' | sed 's/0h//' | sed 's/m$//' | sed 's/.no72h//' | sed 's/_mydelay0.25//' | sed 's/_R2_Feb2022//' | sed 's/.9timepoint12h//' | sed 's/.9timepoint24h//' | sed 's/.9timepoint//' | sed 's/_real0//' | sed 's/.24h//g' )
...
for MYTARGET in Psy1.24h;do #Psy1.june2023 Psy1.june2023.24h;do #Psy1_real0;do #Psy1.9timepoint24h CRTISO.9timepoint24h PhyB2.9timepoint24h;do #CRTISO.nov2021.49and50;do #Psy1 CRTISO.nov2021.49and50 CRTISO.nov2021 PhyB2.2.nov2021;do #Psy1_allb PhyB2.2_allb;do #CRTISO.cleaned PhyB2.2.nov2021 PhyB2.2_R2_Feb2022 Psy1_R2_Feb2022 CRTISO.nov2021.49and50 CRTISO.nov2021 CRTISO_allb CRTISO.49and50bp_allb Psy1_allb PhyB2.2_allb;do
...
MYTARGETM=$( echo $MYTARGET | sed 's/_allb//' |  sed 's/_all//' | sed 's/0h//' | sed 's/m$//' | sed 's/.no72h//' | sed 's/_R2_Feb2022//' | sed 's/_mydelay0.25//' | sed 's/.9timepoint24h//' | sed 's/_real0//g'  | sed 's/.24h//g' )
ERRORMATRIX=~/workspace/daniela/error_matrices/error_matrix4_${MYTARGETM}_errorsfromunbroken.tsv
...
if [ ! -f $OUTPUTA ];then 
#rm $OUTPUTA
bsub -q new-long -J ${NAMESIMS} -e ~/mylogs/${NAMESIMS}-%J.e -o ~/mylogs/${NAMESIMS}-%J.o -R rusage[mem=${MEMS}] ./scripts/run_optimization.sh $TIMECOURSE $ERRORMATRIX ${OUTPUTA} ${mymodel} ${NITER} $likfun ${MYINDUCTION_CURVE} 
fi
...
for mymodel in modelDSBs1i1_3x4;do # modelDSBs1i1_nok12;do # modelDSBs1i1_realimprecise;do #modelDSBs1i1_nok12 modelDSBs1i1_mini modelDSBs1i1_3x4nor11; do #modelDSBs1i1_realimprecise model5i1 modelDSBs1i1_realimpnor11;do
for MYTARGET in Psy1.24h Psy1.june2023 Psy1.june2023.24h;do #Psy1_real0;do #Psy1.9timepoint24h CRTISO.9timepoint24h PhyB2.9timepoint24h;do #Psy1.9timepoint CRTISO.9timepoint PhyB2.9timepoint;do #Psy1 CRTISO.nov2021.49and50 PhyB2.2.nov2021;do #CRTISO.nov2021 Psy1_allb PhyB2.2_allb;do #CRTISO.cleaned PhyB2.2.nov2021 PhyB2.2_R2_Feb2022 Psy1_R2_Feb2022 CRTISO.nov2021.49and50 CRTISO.nov2021 CRTISO_allb CRTISO.49and50bp_allb Psy1_allb PhyB2.2_allb;do
MYTARGETM=$( echo $MYTARGET | sed 's/_allb//' |  sed 's/_all//' | sed 's/_R2_Feb2022//' | sed 's/0h//' | sed 's/m$//' | sed 's/.no72h//' | sed 's/_R2_Feb2022//' | sed 's/_mydelay0.25//'  | sed 's/72h//' | sed 's/.9timepoint24h//'  | sed 's/_real0//g'  | sed 's/.24h//g' )
ERRORMATRIX=~/workspace/daniela/error_matrices/error_matrix4_${MYTARGETM}_errorsfromunbroken.tsv
TIMECOURSE=~/workspace/daniela/input_datasets/timecourse_${MYINDUCTION}_${MYTARGET}${MYDELAY}.txt
if [ $mymodel == "model5i1" ];then
ERRORMATRIX=~/workspace/daniela/error_matrices/error_matrix3_${MYTARGETM}_errorsfromunbroken.tsv
...
if [ -f ${OUTPUT}.a ];then
	...
	bsub -q new-long -J CIs -e ~/mylogs2/confint.e%J -o ~/mylogs2/confint.o%J -R rusage[mem=18000] ./scripts/calculate_CI_v1.sh $OUTPUTALL $TIMECOURSE $ERRORMATRIX $MYN $mymodel $likfun $MYINDUCTION_CURVE
fi
done;done;done;done;done;done
...
for MYTARGET in Psy1.24h Psy1.june2023 Psy1.june2023.24h;do #Psy1_real0;do #Psy1.9timepoint24h CRTISO.9timepoint24h PhyB2.9timepoint24h;do #Psy1 CRTISO.nov2021.49and50 PhyB2.2.nov2021;do # CRTISO.nov2021 Psy1_allb PhyB2.2_allb;do
...
for ip in `seq 1 100`;do
MYTARGETM=$( echo $MYTARGET | sed 's/_allb//' |  sed 's/_all//' | sed 's/0h//' | sed 's/m$//' |  sed 's/.no72h//' | sed 's/_R2_Feb2022//' | sed 's/_mydelay0.25//'  | sed 's/72h//' | sed 's/.9timepoint24h//'  | sed 's/_real0//g'  | sed 's/.24h//g' )
ERRORMATRIX=~/workspace/daniela/error_matrices/error_matrix4_${MYTARGETM}_errorsfromunbroken.tsv
TIMECOURSEPATH=~/workspace/daniela/input_datasets/${bootstraptype}/timecourse_${MYINDUCTION}_${MYTARGET}${MYDELAY}
TIMECOURSE=${TIMECOURSEPATH}/timecourse.bs${ip}.txt
OUTPUTA=~/workspace/daniela/resultsv5/${bootstraptype}/timecourse_${MYINDUCTION}_${MYTARGET}${MYDELAY}/${mymodel}
...
for MYTARGET in Psy1.24h Psy1.june2023 Psy1.june2023.24h;do #Psy1_real0; do #Psy1.9timepoint24h CRTISO.9timepoint24h PhyB2.9timepoint24h;do #Psy1 CRTISO.nov2021.49and50 PhyB2.2.nov2021;do #CRTISO.nov2021 PhyB2 CRTISO.cleaned CRTISO_allb CRTISO.49and50bp_allb Psy1_allb PhyB2.2_allb Psy1 PhyB2.2.nov2021 PhyB2.2_R2_Feb2022 Psy1_R2_Feb2022 CRTISO.nov2021.49and50 CRTISO.nov2021;do 
MYTARGETM=$( echo $MYTARGET | sed 's/_allb//' |  sed 's/_all//' | sed 's/_R2_Feb2022//' | sed 's/0h//' | sed 's/m$//' | sed 's/.no72h//' | sed 's/_R2_Feb2022//' | sed 's/_mydelay0.25//'  | sed 's/72h//' |  sed 's/.9timepoint24h//'  | sed 's/_real0//g' | sed 's/.24h//g' )
ERRORMATRIX=~/workspace/daniela/error_matrices/error_matrix4_${MYTARGETM}_errorsfromunbroken.tsv
TIMECOURSE=~/workspace/daniela/input_datasets/timecourse_${MYINDUCTION}_${MYTARGET}${MYDELAY}.txt
...
for MYTARGET in Psy1.24h Psy1.june2023 Psy1.june2023.24h;do #Psy1_real0;do #Psy1.9timepoint24h CRTISO.9timepoint24h PhyB2.9timepoint24h;do 
