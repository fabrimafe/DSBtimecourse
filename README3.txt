...
for MYINDUCTION in gRNA;do #RNP; do # gRNA;do #Psy1 PhyB2 CRTISO.cleaned for gRNA
for MYINDUCTION_CURVE in 2;do # 
for mymodel in modelDSBs1i1_mini modelDSBs1i1_3x4 modelDSBs1i1_nok12;do  
for MYTARGET in Psy1 PhyB2 CRTISO.cleaned;do #CRTISO_allb CRTISO.49and50bp_allb Psy1_allb PhyB2.2_allb Psy1 PhyB2.2.nov2021 PhyB2.2_R2_Feb2022 Psy1_R2_Feb2022 CRTISO.nov2021.49and50 CRTISO.nov2021;do  
...
for mymodel in modelDSBs1i1_3x4 modelDSBs1i1_nok12 modelDSBs1i1_mini; do # modelDSBs1i1_3x4;do #modelDSBs1i1_mini modelDSBs1i1_nok12 modelDSBs1i1_mini modelDSBs1i1_3x4 modelDSBs1i1_nok12; do 
for MYTARGET in PhyB2.2_R2_Feb2022 Psy1_R2_Feb2022;do #Psy1 PhyB2 CRTISO.cleaned;do #Psy1 PhyB2.2.nov2021 PhyB2.2_R2_Feb2022 Psy1_R2_Feb2022;do #CRTISO.nov2021.49and50 CRTISO.nov2021 CRTISO_allb CRTISO.49and50bp_allb Psy1_allb PhyB2.2_allb;do
...
for MYDELAY in '';do # _mydelay0.25;do #''
for MYINDUCTION in gRNA;do #RNP
...
for mymodel in modelDSBs1i1_3x4 modelDSBs1i1_mini modelDSBs1i1_nok12;do # modelDSBs1i1_3x4;do #modelDSBs1i1_mini modelDSBs1i1_nok12;do 
for MYTARGET in PhyB2.2_R2_Feb2022 Psy1_R2_Feb2022;do #Psy1 PhyB2 CRTISO.cleaned;do #Psy1 PhyB2.2.nov2021 PhyB2.2_R2_Feb2022 Psy1_R2_Feb2022 CRTISO.nov2021.49and50 CRTISO.nov2021;do #Psy1_allb PhyB2.2_allb CRTISO_allb CRTISO.49and50bp_allb;do #CRTISO_allb Psy1_allb PhyB2.2_allb;do #CRTISO.cleanedandnov2021;do
...
for mymodel in modelDSBs1i1_3x4 modelDSBs1i1_mini modelDSBs1i1_nok12;do 
for MYTARGET in PhyB2.2_R2_Feb2022 Psy1_R2_Feb2022;do #Psy1 PhyB2 CRTISO.cleaned;do #Psy1 PhyB2.2.nov2021 PhyB2.2_R2_Feb2022 Psy1_R2_Feb2022 CRTISO.nov2021.49and50 CRTISO.nov2021 CRTISO.49and50bp_allb CRTISO_allb Psy1_allb PhyB2.2_allb;do 
...
myfiles=$( ls /home/labs/alevy/fabrizio/workspace/daniela/resultsv5/results_${mymodel}_${MYINDUCTION}_ind.c${MYINDUCTION_CURVE}_${MYTARGET}.all_n500000.CI /home/labs/alevy/fabrizio/workspace/daniela/resultsv5/${bootstraptype}/timecourse_${MYINDUCTION}_${MYTARGET}/${mymodel}/results_${mymodel}_${MYINDUCTION}_ind.c${MYINDUCTION_CURVE}_${MYTARGET}/results*.tab_n50000.CI )
for ifile in $myfiles;do
cat $ifile | awk -v OFS='\t' '{if (ar[$4]==1){$4=$4".1"}; ar[$4]=1; print $0}' > ${ifile}.t.CI 
echo $ifile
done
ls /home/labs/alevy/fabrizio/workspace/daniela/resultsv5/results_${mymodel}_${MYINDUCTION}_ind.c${MYINDUCTION_CURVE}_${MYTARGET}.all_n500000.CI.t.CI > $listCIFILE 
...
#for bootstraptype in stratifiedbootstraps2;do 
for mymodel in modelDSBs1i1_3x4 modelDSBs1i1_mini modelDSBs1i1_nok12;do 
for MYTARGET in Psy1 PhyB2.2.nov2021 PhyB2.2_R2_Feb2022 Psy1_R2_Feb2022 CRTISO.nov2021.49and50 CRTISO.nov2021 CRTISO.49and50bp_allb CRTISO_allb Psy1_allb PhyB2.2_allb;do 
for bootstraptype in stratifiedbootstraps;do #stationarybootstraps MEbootstraps; do #MEbootstraps stationarybootstraps
...
TIMECOURSE=~/workspace/daniela/input_datasets/timecourse_${MYINDUCTION}_${MYTARGET}.txt
listCIFILE=/home/labs/alevy/fabrizio/workspace/daniela/resultsv5/${bootstraptype}/timecourse_${MYINDUCTION}_${MYTARGET}/${mymodel}/results_${mymodel}_${MYINDUCTION}_ind.c${MYINDUCTION_CURVE}_${MYTARGET}/listCIfiles.txt
ls /home/labs/alevy/fabrizio/workspace/daniela/resultsv5/results_${mymodel}_${MYINDUCTION}_ind.c${MYINDUCTION_CURVE}_${MYTARGET}.all_n50000.CI > $listCIFILE
ls /home/labs/alevy/fabrizio/workspace/daniela/resultsv5/${bootstraptype}/timecourse_${MYINDUCTION}_${MYTARGET}/${mymodel}/results_${mymodel}_${MYINDUCTION}_ind.c${MYINDUCTION_CURVE}_${MYTARGET}/results*.tab_n20000.CI >> $listCIFILE
bsub -q new-short -J plotshort -e ~/mylogs4/plot.e%J -o ~/mylogs4/plot.o%J -R rusage[mem=16000] ./plot.v2.sh $listCIFILE $TIMECOURSE $ERRORMATRIX $mymodel 1000 ${OUTPUTTOT}.plot $likfun ${MYINDUCTION_CURVE} ${TIMERESOLUTION} 1
done;done;done;done;done;done
